    ...
    return (
        ...
        <div className={`flex justify-between ${className}`} >
            <div className='flex gap-4 relative'>
                ...
                <Link to={`/watch/v=${id}`}>
                    <div className={`relative cov min-w-64.5 max-w-64.5  min-h-36.5 max-h-36.5 rounded-xl overflow-hidden aspect-video `}>
                ...
                <div className={`gText`}>
                    ...
                    <div className='flex gap-3'>
                        <Link
                            ...
                            <img className='h-7 rounded-full' src={channelProfile} alt="" />
                        </Link>
